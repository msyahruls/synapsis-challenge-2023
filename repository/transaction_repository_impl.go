...
// func (repository *TransactionRepositoryImpl) Update(transaction domain.Transaction, transactionId string) {
// 	ctx, cancel := config.NewDBContext()
// 	defer cancel()
...
// func (repository *TransactionRepositoryImpl) AssignPermission(transaction domain.Transaction, transactionId string) {
// 	ctx, cancel := config.NewDBContext()
// 	defer cancel()
...
// 			// "permissions": transaction.Permission,
// 		},
// 	}
...
// func (repository *TransactionRepositoryImpl) Delete(transactionId string) error {
// 	ctx, cancel := config.NewDBContext()
// 	defer cancel()
